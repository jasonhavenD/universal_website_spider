...
INPUT_URL_FILE = './input/input_url.csv'
...
DEFAULT_FLAGS = {
    ...
    'default_thread': 3,  # 线程数
    'default_need_vpn': 0,  # vpn是否需要
...
RETRY_CFG = {
    ...
    'wait_random_min': 1000 * 3,  # 连续重试随机时间下线毫秒，推荐3
    'wait_random_max': 1000 * 8  # 连续重试随机时间上线毫秒，推荐10
}
